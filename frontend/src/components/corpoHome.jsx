export function CorpoHome() {
    return (
        <section class="bg-white dark:bg-gray-900">
            <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">

                <h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-white">Seja bem vindo(a) ao meu portfólio</h1>
                <p class="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">Aqui você verá o meu repertório em tecnologia, os meus projetos de forma dinâmica, ferramentas que eu sei usar e tenho familiaridade.</p>
                ...
                <div class="flex flex-wrap justify-center items-center mt-8 text-gray-500">
                    <a
                        href="https://linkedin.com/in/matheus-dacruz-lima"
                        target="_blank"
                    ...
                    <a
                        href="https://github.com/maatheusdacruz"
                        target="_blank"
                        rel="noopener noreferrer"
                        class="mr-5 mb-5 lg:mb-0 hover:text-gray-800 dark:hover:text-gray-400"
                    >
